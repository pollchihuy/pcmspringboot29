...
import com.juaracoding.pcmspringboot29.config.JwtConfig;
...
import com.juaracoding.pcmspringboot29.repo.UserRepo;
import com.juaracoding.pcmspringboot29.security.BcryptExample;
import com.juaracoding.pcmspringboot29.security.Crypto;
import com.juaracoding.pcmspringboot29.security.JwtUtility;
...
//
    ...
    public ResponseEntity<Object> verifyRegis(User user, HttpServletRequest request) {
        try {
            ...
            if(!BcryptImpl.verifyHash(userNext.getUsername()+user.getOtp(),userNext.getOtp())) {
            ...
            userNext.setOtp(BcryptImpl.hash(String.valueOf(otp)));//matiin akses otp yang lama agar tidak bisa digunakan lagi
        }catch (Exception e){
