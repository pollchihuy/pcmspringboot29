...
//public class ContohCustomerController {
//
...
//    public Object saveWithValidation(@Valid @RequestBody CustomerDTO customer, HttpServletRequest request){
////        Map<String,Object> map = new HashMap<>();
////        map.put("email","paul@gmail.com");
////        map.put("nama","Paul");
////        map.put("username","paul123");
...
//    //POST localhost:8080/customer
//    @PostMapping
//    public Object save(@RequestBody CustomerDTO customerDTO,HttpServletRequest request){
//        try{
//            int x = 1/0;
//            Map<String,Object> mParent = new HashMap<>();
//            mParent.put("timestamp", LocalDateTime.now());
...
//            System.out.println("Tanggal Lahir : "+customerDTO.getTanggalLahir());
//        }catch (Exception e){
