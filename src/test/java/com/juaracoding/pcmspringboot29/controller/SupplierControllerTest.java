...
public class SupplierControllerTest extends AbstractTestNGSpringContextTests {
    ...
    void findAll(){
        ...
        try{
            ...
            sizeAllData = supplierRepo.count();
//            System.out.println(response.getBody().prettyPrint());
            Assert.assertEquals(intResponse,200);
            Assert.assertEquals(jsonPath.getString("message"),"DATA DITEMUKAN");
            Assert.assertTrue(Boolean.parseBoolean(jsonPath.getString("success")));
...
// ======================================================================================================================================================
            Assert.assertEquals(map.get("nama"),supplier.getNama());
    ...
    void uploadExcel(){
        ...
        try{
            response = given().
                    ...
                    header("Accept","application/json").
                    header(AuthControllerTest.AUTH_HEADER,AuthControllerTest.token).
                    multiPart("filez",new File(System.getProperty("user.dir")+"/src/test/resources/data-test/supplier.xlsx"),
